...
int main()
{
  ...
  //std::vector<IntVec> *vecints = new std::vector<IntVec>[TestSize];		//test using new and delete directly, some codes need noting
  ...
  //std::vector<PointVec> *vecpts = new std::vector<PointVec>[TestSize];		//test using new and delete direclty, some codes need noting
